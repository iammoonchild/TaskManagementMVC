...
public partial class TaskLog
{
    ...
    public virtual AspNetUser? CommentedBy { get; set; }

    public virtual LogType LogType { get; set; } = null!;

    public virtual Task Task { get; set; } = null!;

    public virtual AspNetUser? TransferredBy { get; set; }

    public virtual AspNetUser? TransferredFrom { get; set; }

    public virtual AspNetUser? TransferredTo { get; set; }
}
